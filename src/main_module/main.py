...
def initialize(locator):
    ...
    measurement_viewmodel = MeasurementViewModel()
    locator.register_service("measurement_viewmodel", measurement_viewmodel)
    measurement_view = MeasurementView()
    locator.register_service("measurement_view", measurement_view)
    ...
    navigation_service.register_view(
        ViewType.SETTINGS, locator.get_service("settings_view")
    )
    navigation_service.register_view(
        ViewType.CALIBRATION, locator.get_service("wizard_view")
    )
    navigation_service.register_view(ViewType.MEASUREMENT, measurement_view)
