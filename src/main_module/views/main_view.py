...
class MainView(QWidget):
    ...
    def connect_signals(self):
        self.calibrate_btn.clicked.connect(lambda: self.view_model.navigate_to(ViewType.CALIBRATION))
        self.settings_btn.clicked.connect(lambda: self.view_model.navigate_to(ViewType.SETTINGS))
